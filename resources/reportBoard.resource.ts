export class ReportBoardResource {
	...
	getReportBoardIndex() {
		return this.reportBoardIndex;
	}

	setReportBoardIndex(reportBoardIndex) {
		this.reportBoardIndex = reportBoardIndex;
	}
	...
	getReportBoardTitle() {
		return this.reportBoardTitle;
	}

	setReportBoardTitle(reportBoardTitle) {
		this.reportBoardTitle = reportBoardTitle;
	}

	getReportBoardContent() {
		return this.reportBoardContent;
	}

	setReportBoardContent(reportBoardContent) {
		return this.reportBoardContent = reportBoardContent;
	}
