        ...
        switch (err) {
            case 'No Content':
                res.send({
                    success: true,
                    statusCode: 204,
                    message: 'pageListBoardInfoBySearchTerm 204'
                })
                break;
        ...
        switch (err) {
            case 'No Content':
                res.send({
                    success: true,
                    statusCode: 204,
                    message: 'pageListBoardInfoByCategory 204'
                })
                break;
        ...
        switch (err) {
            case 'No Content':
                res.send({
                    success: true,
                    statusCode: 204,
                    message: 'pageListBoardInfoByPost 204'
                })
                break;
        ...
        switch (err) {
            case 'No Content':
                res.send({
                    success: true,
                    statusCode: 204,
                    message: 'getPostByBoardIndex 204'
                })
                break;
