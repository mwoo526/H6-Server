        ...
        switch(err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'createTodayLunchMenu: 500'
                })
        }
    }
}
        ...
        switch(err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'getTodayLunchMenus: 500'
                });
        }
    }
}
        ...
        switch (err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'getTodayLunchMenuByIndex: 500'
                });
        }
    }
}
        ...
        switch (err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'getTodayLunchByTodayLunchIndex: 500'
                });
        }
    }
}
        ...
        switch (err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'updateTodayLunchMenu: 500'
                });
        }
    }
}
        ...
        switch (err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'deleteTodayLunchMenu: 500'
                });
        }
    }
}
        ...
        switch (err) {
            default:
                res.send({
                    success: false,
                    statusCode: 500,
                    message: 'deleteTodayLunchMenuByTodayLunchIndex: 500'
                });
        }
    }
}
