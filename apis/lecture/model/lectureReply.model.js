...
class LectureReply {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`INSERT INTO lectureReply SET ?`, lectureReplyData, function (err) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
    ...
    countGetLectureReplyByLectureInfoIndex(lectureInfoIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`SELECT COUNT(*) AS replyCount FROM lectureReply WHERE lectureReply.lectureInfoIndex = ${lectureInfoIndex}`, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
    ...
    checkGetLectureReply(lectureInfoIndex, userIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`SELECT COUNT(*) AS replyCount FROM lectureReply WHERE lectureReply.lectureInfoIndex = ${lectureInfoIndex} AND lectureReply.userIndex = ${userIndex}`, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
    ...
    checkUpdateLectureReply(lectureInfoIndex, userIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`SELECT * FROM lectureReply WHERE lectureReply.lectureInfoIndex = ${lectureInfoIndex} AND lectureReply.userIndex = ${userIndex}`, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
    ...
    updateLectureReply(lectureReplyIndex, lectureReplyData) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`UPDATE lectureReply SET ? WHERE lectureReplyIndex = ?`, [lectureReplyData,
    ...
    deleteLectureReply(lectureReplyIndex) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query('DELETE FROM lectureReply WHERE lectureReplyIndex = ?', lectureReplyIndex, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
    ...
    deleteLectureReplyByUserIndex(userIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query('DELETE FROM lectureReply WHERE userIndex = ?', userIndex, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
    ...
    scoreGetLectureReply(lectureInfoIndex) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            yield pool.getConnection(function (err, connection) {
                return __awaiter(this, void 0, void 0, function* () {
                    yield connection.query(`SELECT AVG(score) AS totalScore FROM lectureReply WHERE lectureInfoIndex = ${lectureInfoIndex}`, function (err, rows) {
                        return __awaiter(this, void 0, void 0, function* () {
                            if (err) {
                                yield connection.release();
                                reject(err);
